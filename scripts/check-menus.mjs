 ...
 * (브랜드·가게 이름은 문제가 아니다 — owner 가 일부러 넣은 것이다)
 * 다시 새어 들어오지 않게 고정한다.
 *
 ...
 *
 * ⚠️ **브랜드·가게 이름은 금지어가 아니다.** 뿌링클·교촌치킨·맥도날드·엽기떡볶이는
 *    owner 가 일부러 넣은 것이다("오늘 맥도날드" 처럼 그 이름으로 정한다).
 *    `매운족발`·`매운돼지갈비` 도 따로 파는 메뉴다.
 *    여기 남기는 것은 **"매운"·"청양"·"치즈" 를 붙여 만든 없는 이름**뿐이다.
 */
const BANNED = [
  "청양떡볶이", "치즈치킨", "매운찜닭", "매운낙지볶음", "냉국수",
];
