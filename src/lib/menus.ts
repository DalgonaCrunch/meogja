...
export const MENU_CATEGORIES: MenuCategory[] = [
  ...
  { emoji:"🍜", label:"국물", menus:["김치찌개","된장찌개","부대찌개","설렁탕","갈비탕","순대국밥","해장국","육개장","추어탕","콩나물국밥","선지국밥","뼈다귀해장국","감자탕","칼국수","짬뽕","갈낙전골","곰탕","삼계탕","떡국"] },
  { emoji:"🍣", label:"일식", menus:["초밥","라멘","돈카츠","우동","소바","카라아게","텐동","규동","오마카세","이자카야안주","사시미","야키토리","치즈돈까스","나베","스키야키","생선구이","회","회덮밥","마끼","장어덮밥","돈카스","오므라이스","카레라이스","하이라이스","돌솥비빔밥"] },
  ...
  { emoji:"🌶️", label:"매운맛", menus:["떡볶이","마라탕","마라샹궈","낙지볶음","쭈꾸미볶음","엽기떡볶이","매운갈비찜","불닭","매운족발","불짬뽕","청양떡볶이","매운찜닭","매운낙지볶음","매운돼지갈비","핵불닭","로제떡볶이","치즈떡볶이"] },
  { emoji:"🍰", label:"디저트", menus:["아이스크림","붕어빵","호떡","마카롱","타르트","팥빙수","츄러스","도넛","케이크","크레이프","소프트아이스크림","약과","카스텔라","초콜릿","젤라또","쿠키","브라우니","초코케이크","치즈케이크","푸딩"] },
  { emoji:"🍱", label:"한식", menus:["비빔밥","덮밥","김밥","잡채","짜장면","짬뽕","냉면","소면","물냉면","비빔냉면","쫄면","국수","라면","김치","닭갈비","볶음밥","김치볶음밥","막국수","비빔국수","파전","전복죽","주먹밥","만두","짜장밥","야채볶음"] },
  { emoji:"🥟", label:"중식", menus:["짜장면","짬뽕","탕수육","깐풍기","유산슬","마파두부","훠궈","마라샹궈","딤섬","양꼬치","간풍기","팔보채","해파리냉채","중화비빔밥","공심채볶음","간짜장","깐풍새우","라조기","북경오리","사오마이","춘권"] },
  { emoji:"🦞", label:"해산물", menus:["회","회덮밥","초밥사시미","새우튀김","굴요리","홍합요리","간장게장","꽃게찜","해물찜","샤브샤브"] },
];
