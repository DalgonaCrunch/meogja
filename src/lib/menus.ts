...
export const MENU_CATEGORIES: MenuCategory[] = [
  ...
  { emoji:"🌶️", label:"매운맛", menus:["김치찌개","순두부찌개","부대찌개","제육볶음","닭갈비","짬뽕","떡볶이","마라탕","마라샹궈","낙지볶음","쭈꾸미볶음","엽기떡볶이","매운갈비찜","불닭","매운족발","불짬뽕","청양떡볶이","매운찜닭","매운낙지볶음","매운돼지갈비","핵불닭","로제떡볶이","치즈떡볶이"] },
  { emoji:"🍰", label:"디저트", menus:["아이스크림","붕어빵","호떡","마카롱","타르트","팥빙수","츄러스","도넛","케이크","크레이프","소프트아이스크림","약과","카스텔라","초콜릿","젤라또","쿠키","브라우니","초코케이크","치즈케이크","푸딩"] },
  { emoji:"🍱", label:"한식", menus:["김치찌개","된장찌개","순두부찌개","부대찌개","설렁탕","갈비탕","해장국","삼계탕","제육볶음","불고기","삼겹살","갈비","보쌈","족발","닭갈비","비빔밥","돌솥비빔밥","덮밥","김밥","잡채","냉면","소면","물냉면","비빔냉면","쫄면","국수","라면","김치","볶음밥","김치볶음밥","막국수","비빔국수","파전","전복죽","주먹밥","만두","떡볶이"] },
